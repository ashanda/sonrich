        ...
        <div class="mt-2">
            ...
            <table class="table table-bordered table-striped dataTable dtr-inline">
                ...
                <tr>
                    ...
                    <td><span class="curr-val">{{ $product->product_price }}</span></td>
                    <td><span class="curr-val">{{ $product->product_face_price }}</span></td>
        ...
        <div class="row">
            ...
            <table class="table table-bordered table-striped dataTable dtr-inline">
                ...
                <tr>
                    ...
                    <td><span class="curr-val">{{ $oder->product_price }}</span></td>
